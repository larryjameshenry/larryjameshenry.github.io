...
gemini --yolo --model $Model "/research $Topic" | Out-File $ResearchFile -Append -Encoding UTF8
...
$FullPrompt = $ResearchContent + "`n`n" + "/outline $OutlineArgs"
gemini --yolo --model $Model $FullPrompt | Out-File $ArticlePath -Encoding UTF8
