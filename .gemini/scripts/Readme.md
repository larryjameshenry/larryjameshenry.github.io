...
.gemini\scripts\New-TopicCluster.ps1 -Topic "PowerShell Automation for DevOps"
...
.gemini\scripts\Generate-Outlines.ps1 -SeriesName "powershell-automation-for-devops"
...
.gemini\scripts\Promote-Outline.ps1 -SeriesName "powershell-automation-for-devops" -Number 1
...
.gemini\scripts\Expand-Article.ps1 -Slug "getting-started-powershell-automation"

# Step 9: Review and polish
code content/posts/getting-started-powershell-automation.md

# Step 10: Publish when ready
.gemini\scripts\Publish-Article.ps1 -Slug "getting-started-powershell-automation"

# Step 11: Repeat for next article in series
.gemini\scripts\Promote-Outline.ps1 -SeriesName "powershell-automation-for-devops" -Number 2
```
## Example 2: Create Smaller Series
```
# Quick cluster on specific topic
.gemini\scripts\New-TopicCluster.ps1 -Topic "SQL Server Performance Tuning" -SeriesName "sql-perf"

# Generate just first 3 articles
.gemini\scripts\Generate-Outlines.ps1 -SeriesName "sql-perf" -Count 3

# Work through them one by one
.gemini\scripts\Promote-Outline.ps1 -SeriesName "sql-perf" -Number 1
.gemini\scripts\Expand-Article.ps1 -Slug "sql-server-performance-basics"
.gemini\scripts\Publish-Article.ps1 -Slug "sql-server-performance-basics"
```

## Complete Workflow with Fact-Checking
```powershell
# 1. Create outline
.gemini\scripts\New-Article.ps1 -Topic "PowerShell Error Handling"

# 2. Expand to full article
.gemini\scripts\Expand-Article.ps1 -Slug "powershell-error-handling"

# 3. Fact-check the article
.gemini\scripts\Test-ArticleAccuracy.ps1 -Slug "powershell-error-handling" -OutputFile "factcheck.md"

# 4. Test code examples
.gemini\scripts\Test-ArticleCode.ps1 -Slug "powershell-error-handling"
...
.gemini\scripts\Test-ArticleAccuracy.ps1 -Slug "powershell-error-handling"

# 7. Final polish
gemini --add content/posts/powershell-error-handling.md "/finalize" > polish.md

# 8. Publish (includes optional fact-check)
.gemini\scripts\Publish-Article.ps1 -Slug "powershell-error-handling"
```
