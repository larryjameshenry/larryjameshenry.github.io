...
try {
    $TestOutput = & gemini --yolo --model $Model "test" 2>&1 | Out-String
...
"@
    ...
    try {
        $RawOutput = & gemini --yolo --model $Model $PillarPromptWithContext 2>&1 | Out-String
...
"@
    ...
    try {
        ...
        $RawOutput = & gemini --yolo --model $Model $OutlinePromptWithContext 2>&1 | Out-String
